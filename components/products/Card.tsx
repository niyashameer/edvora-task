...
const Card = (props: any) => {
	return (
		<div className='w-[217px] h-[150px] bg-background rounded-[4.68775px] p-4 hover:scale-[1.10] z-[100] my-[1.5rem] mx-[1.5rem] shrink-0'>
			<div className='h-[60%]'>
			...
			<div className='mt-2'>
				<div className='text-white opacity-60 font-[400] flex flex-row'>
					<div className='text-[13px] w-[48%] overflow-clip text-ellipsis'>{props.product.address.state}</div>
					<div className='text-left text-[12px] -ml-1.5'>
						Date:
